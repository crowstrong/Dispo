...
class OrderTestCase(TestCase):
    ...
    def test_order_model(self):
        ...
        self.assertEqual(self.order.company_name, self.user)
        ...
        self.assertEqual(self.order.trailer_details, self.trailer)
